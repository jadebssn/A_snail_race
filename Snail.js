class Snail {
  ...
  render() {
    const snailRacer = document.createElement("div");
    snailRacer.className = "snail-racer";
    snailRacer.innerHTML = `<svg class="snail" viewBox="0 0 260 200" xmlns="http://www.w3.org/2000/svg">
    ...
    snailRacer.querySelector(".snail__body").style.fill = this.color;
    snailRacer.addEventListener("click", () => this.update());
    this.snailRacer = snailRacer;
    return snailRacer;
  }
  ...
  update() {
    ...
    console.log(this.snailRacer);
    clearInterval(this.interval);
    this.interval = setInterval(() => {
      console.log(currentPosition);
      const newPosition = currentPosition + this.speed;
      this.snailRacer.style.marginLeft = newPosition + "px";
